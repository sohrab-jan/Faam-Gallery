...
<head>
  ...
  ================================================== -->
	<meta charset="utf-8">
	<title>Sohrab Shaheed Salles</title>
					...
					<div class="col-2-3">
						...
						<div id='cssmenu'>
							<ul>
							   ...
							   <li><a href='single.html'><span>Activities</span></a></li>
							   <li><a href='archive.html'><span>history</span></a></li>
					...
					<div class="row wrap-box"><!--Start Box-->
						<div class="col-1-2">
							<div class="box-text bg-2">
								<div class="heading">
									<h2>Filmography as director  </h2>
                                    <h4>
                                        Short
                                    </h4>
                                    <p>
                                        Dance of Bojnourd (Short) 1969
                                    </p>
                                    <p>
                                        Resurrection (Documentary short) 1969
                                    </p>
                                    <p>
                                       black and white (Short) 1972
                                    </p>
                                    <h4>
						...
						<div class="col-1-2">
							<div class="box-text bg-3">
								...
								<div class="content">
                                    ...
                                    <p>
                                        Hans: A young man in Germany, 1985.
                                    </p>
                                    <p>
                                        Changeling, 1987.
                                    </p>
