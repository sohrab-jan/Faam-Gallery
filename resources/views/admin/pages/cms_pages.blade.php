...
@section('content')
    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <div class="col-lg-12 justify-content-center justify-items-center">
{{--            <div class="row">--}}
                    ...
                    @foreach($CmsPages as $page)
                        <tr>
                            ...
                            <td>
                                ...
                                @else
                                    <a class="updateCmsPageStatus" id="page-{{ $page['id'] }}" page_id="{{ $page['id'] }}" style="color:gray">
                                        <i class="fas fa-toggle-on" status="Inactive"></i></a>
                                @endif
                            </td>
{{--                            <td>--}}
