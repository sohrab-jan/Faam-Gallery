        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('allframeassets') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>frame asset List</p>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('admin.artists.store') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>New Artist</p>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('admin.services.store') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>New Service</p>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('allprinting') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Printing List</p>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{route('framelist')}}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Framing List</p>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{route('all-exhibition')}}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Exhibition List</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('addexhibition')}}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>New Exhibition</p>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{route('add_blogs')}}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>New Blog</p>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    <a href="{{ route('allcontacts') }}" class="nav-link">
