...
(function( $, window, document, undefined ) {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 * * `\_PAGES\_` - Total number of layout of data in the table
			 *
			 *  @type string
	...
	DataTable.ext = _ext = {
		 ...
		 * 2. `{int} layout` The number of layout in the table
		 *
		 ...
		 *    $.fn.dataTableExt.oPagination.current = function ( page, layout ) {
